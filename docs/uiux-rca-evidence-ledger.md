...
| MUI-005 | P2 | Auth, transactions, holdings, settings, collaboration, import | Shared inputs render at 0.9rem and the compact rule changes only height, leaving iOS form focus susceptible to automatic viewport zoom and reflow. | `frontend/src/App.css:2543-2554`, `frontend/src/App.css:6697-6702` | W1 shell/layout | Open | Pending: `.omo/evidence/mobile-uiux-v0.1.49/MUI-005/` must record computed 16px-or-greater form text across the mobile matrix. |
