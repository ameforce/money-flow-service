...
| MUI-005 | P2 | Short landscape on auth, dashboard filters, settings, collaboration, and import | The compact form contract stopped at 900px, excluding 915x412. The short-landscape boundary now covers 920px and the affected surface inputs, selects, and textareas have a scoped 16px minimum. | `frontend/src/App.css`, `e2e/specs/mobile-browser-matrix.spec.js` | W1 shell/layout | Fixed and verified | WebKit verifies auth, dashboard filters, settings, collaboration, and import at 915x412 and 844x390; evidence: `.omo/evidence/mobile-uiux-v0.1.49/MUI-005/`. |
