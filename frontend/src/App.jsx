...
function App() {
  ...
  return (
    ...
    >
      ...
      {tab === "dashboard" && <DashboardPage view={dashboardPageView} />}

      {tab === "transactions" && <TransactionsPage view={transactionsPageView} />}

      {tab === "holdings" && <HoldingsPage view={holdingsPageView} />}

      {tab === "settings" && <SettingsPage view={settingsPageView} />}

      {tab === "collaboration" && <CollaborationPage view={collaborationPageView} />}

      {tab === "import" && <ImportPage view={importPageView} />}
      </div>
      {confirmDialog.open && (
        <div
